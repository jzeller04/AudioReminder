...
const fetchReminder = require('./server/controllers/fetchReminder');
const bodyParser = require('body-parser');
const fs = require('fs');
const {signInSuccess} = require('./server/controllers/signIn.js');
const {createUserWithSignUp} = require('./server/controllers/signUp.js');
const session = require('express-session');
const User = require('./server/models/user.js');
const {saveReminderToUser, saveUserSettings} = require('./server/controllers/saveReminderToUser.js');
const {dateToReadable, timeToTwelveSystem} = require('./server/util/util.js');
...
app.get('/settings', (request, response) => 
    ...
    return response.sendFile('settings.html', { root: path.join(__dirname, 'views') });
    }
);
