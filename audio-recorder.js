(function() {
    ...
    function createUI() {
        ...
        ttsButton.textContent = 'Play TTS';
        ttsButton.disabled = true; // Initially disabled until there's a transcript
    ...
    function addEventListeners() {
        ...
        ttsButton.addEventListener('click', playTTS); // Add event listener for TTS button
    }
    ...
    function stopRecording() {
        if (mediaRecorder && isRecording) {
            ...
            ttsButton.disabled = false; // Enable TTS button after recording stops
        }
    }
    ...
    function deleteAudio() {
        ...
        saveButton.disabled = true;
        deleteButton.disabled = true;
        ttsButton.disabled = true; // Disable TTS button again
    }
    
    // Play transcript text using TTS
    function playTTS() {
        if (transcriptText) {
            const utterance = new SpeechSynthesisUtterance(transcriptText);
            speechSynthesis.speak(utterance);
            console.log("Playing TTS: ", transcriptText);
        }
    }
  })();
